<?php
	...
	if($_SERVER['REQUEST_METHOD'] === "POST"){
		if(isset($_FILES['file'])){
			...
			$error = "Please select a file to covert into a text";
		}
	}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>
        Voycet Ai - Convet Audio into written text
	</title>
    <!-- FONT-AWESOME LINK -->
		...
		<div class="h-full border-2 rounded-xl border-gray-700" style="width: 1280px; max-height: 1080px; box-shadow: -20px 20px 0px 0px #74a840,-21px 21px 0px 3px #343333">
			<div class="flex h-full flex-col items-center">
				...
				<div id="upload" class=" flex flex-col text-center mt-40" style="width: 600px;">
					...
					<h1 class="text-4xl py-2">Welecome to Voycet</h1>
					<p class="text-xl">
                      Voycet is an AI tool that allows you to convert audio files into text and also translate the text into your desired language.					</p>
